...
4. Pastikan MinGW sudah terdaftar di PATH dengan menjalankan perintah berikut di terminal VS Code: gcc --version. Jika muncul versi GCC, berarti compiler sudah siap digunakan.

B. Instalasi
1. Clone repository ini melalui terminal VS Code: git clone https://github.com/rainissa/TXTree.git
2. Masuk ke folder project: cd TXTree

C. Cara Pakai
1. Buka folder project di VS Code (File > Open Folder).
2. Buka terminal VS Code dengan Ctrl + \`.
3. Compile file C menggunakan GCC di terminal VS Code: gcc *.c -o main
4. Jalankan program hasil compile: .\main.exe
